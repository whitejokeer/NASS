...
class RegisterAppLayout extends StatefulWidget {
  @override
  _RegisterAppLayoutState createState() => _RegisterAppLayoutState();
}

class _RegisterAppLayoutState extends State<RegisterAppLayout> {
